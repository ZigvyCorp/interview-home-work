...
import { getPostsFailure, getPosts } from '../actions/postAction'
...
export const loadingPostsSelector = (state: RootState) => state.blacklist.loadingPosts
