...
import { createPostSuccess, deletePostSuccess, getPostsSuccess, updatePostSuccess } from '../slices/postsSlice'
import { createPostFailure, deletePostFailure, getPostsFailure, updatePostFailure } from '../actions/postAction'
import { postsApi } from 'src/apis/post'
...
function* postsSaga() {
  yield takeLatest('posts/getPosts', fetchPostSaga)
  yield takeLatest('posts/createPost', fetchCreatePostSaga)
  yield takeLatest('posts/updatePost', fetchDeletePostSaga)
  yield takeLatest('posts/deletePost', fetchUpdatePostSaga)
}
