...
import { APP_CLIENT_INTERNALS, BARREL_OPTIMIZATION_PREFIX, COMPILER_NAMES, EDGE_RUNTIME_WEBPACK, SERVER_REFERENCE_MANIFEST } from "../../../shared/lib/constants";
...
export class FlightClientEntryPlugin {
    ...
    injectActionEntry({ compiler, compilation, actions, entryName, bundlePath, fromClient }) {
        ...
        if (actionsArray.length > 0 && semver.lt(process.version, "18.11.0")) {
            compilation.errors.push(new compilation.compiler.webpack.WebpackError("Your version of Node does not support server actions. Please upgrade to Node 18.11 or higher."));
