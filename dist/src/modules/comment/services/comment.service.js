...
let CommentService = class CommentService {
    constructor(commentRepository, blogService) {
    ...
    async createComment(comment) {
        try {
            ...
            const newComment = new comment_entity_1.CommentEntity();
...
CommentService = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.Repository, blog_service_1.BlogService])
], CommentService);
