          ...
          <div className=" bg-main  flex flex-col justify-center items-center px-[50px]">
            ...
            <form className="w-full" onSubmit={formik.handleSubmit}>
              ...
              <div>
                <Link
                  ...
                  className="text-sm text-red-500 flex justify-end mt-1 italic cursor-pointer ease-out duration-300  hover:underline"
                >
                  Forgot password
                </Link>
              </div>
            ...
            <div className="flex justify-center w-full mt-3 ">
              <p>Not have already register? <span>
                <Link
                  to={`/${path.REGISTER}`}
                  className="text-sm italic cursor-pointer ease-out duration-300 text-red-500 hover:underline"
                >
                  Sign up
                </Link>
              </span></p>
